    ...
    <div>
        <div class="row justify-content-center mb-4">
            <!-- <div class="d-flex flex-wrap justify-content-start gap-3 mb-4 mx-3">
                ...
                <button class="btn btn-outline-secondary" @click="toColorManager">
                    <i class="fas fa-palette me-1"></i> Màu sắc sản phẩm
                </button>
                <button class="btn btn-outline-info" @click="toSizeManager">
                    <i class="fas fa-ruler me-1"></i> Kích thước chung
                </button>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control mb-2" v-model="filters.searchCategory" placeholder="Nhập danh mục sản phẩm">
                <input type="text" class="form-control mb-2" v-model="filters.searchBrand" placeholder="Nhập thương hiệu">
                <input type="text" class="form-control mb-2" v-model="filters.searchDiscount" placeholder="Nhập tên chương trình khuyến mãi">
                <select class="form-select mb-2" v-model="filters.isActive">
        ...
        const fetchProduct = async () => {
            try {
                ...
                for (let product of productsData) {
                    const price_suggess = await axios.get(`http://127.0.0.1:3000/api/suggestedPrice/${product._id}`);
                    product.suggessPrice = price_suggess.data.suggestedPrice;
