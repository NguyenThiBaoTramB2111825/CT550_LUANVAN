  ...
  <div class="row mx-3">
    ...
    <div class="col-md-3 mt-4">
      <div class="bg-white rounded shadow">
        ...
        <p
          class="text-center pt-4 cursor-pointer"
          :class="{ 'fw-bold text-primary text-decoration-underline': activeTab === 'info' }"
          @click="activeTab = 'info'; open = false"
      >
        Thông tin tài khoản
      </p>
      <p
          class="text-center pt-2 cursor-pointer"
          :class="{ 'fw-bold text-primary text-decoration-underline': activeTab === 'favorites' }"
          @click="activeTab = 'favorites'; open = false"
        >
          Sản phẩm yêu thích
      </p>
      <p
          class="text-center pt-2 cursor-pointer"
          :class="{ 'fw-bold text-primary text-decoration-underline': open }"
          @click="open = true"
        >
          Đổi mật khẩu
      </p>
