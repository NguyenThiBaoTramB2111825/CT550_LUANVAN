...
<template>
  ...
  <template>
    <div class="container py-4">
      ...
      <div ref="pdfContent" class="invoice-wrapper">
      <!-- <div ref="pdfContent" class="invoice-wrapper p-4 border rounded bg-white"> -->
        ...
        <div class="card shadow-sm mb-3">
          ...
          <div class="d-flex justify-content-end p-3 bg-light flex-column align-items-end">
            ...
            <div class="fs-5 fw-bold mt-2">TỔNG CỘNG: {{ formatCurrency(order.totalPrice) }} VNĐ</div>
          </div>
        </div>
  
        <!-- <div class="text-end">
            <p>Dấu xác nhận của cửa hàng</p>
        </div> -->
        <div class="text-end mt-5">
          <p><strong>Dấu xác nhận của cửa hàng</strong></p>
          <img src="" alt="Dấu cửa hàng" style="width: 120px; margin-top: 10px;" />
        </div>
      <br><br><br>
      </div>
...
export default {
  ...
  .invoice-wrapper {
    border: 6px solid #27572c; /* Màu viền giống mẫu hóa đơn */
    padding: 20px;
    max-width: 800px;
