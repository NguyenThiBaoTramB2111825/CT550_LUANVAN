<template>
       <Breadcrumb  class="text-end" />
        <h5 class="text-center">Thêm nhân viên kho</h5>
        ...
        <form class="col-md-8 offset-md-2 ">
            ...
            <div class="mb-3 d-flex">
                ...
                <input type="password"  v-model="warehousemanager.password" class="form-control"  required>
            </div>
        </form>

             
        <div class=" d-flex justify-content-center text-center">
            <button class="btn btn-success " @click="addWareHouseManager" >
                Thêm mới
            </button>
...
export default {
    ...
    setup() {
        ...
        const addWareHouseManager = async () => {
            ...
            try {
                ...
                formData.append("password", warehousemanager.value.password);
                if (selectedFile.value) {
                    formData.append("profileImage", selectedFile.value);
                }
                console.log("Dữ liệu gửi lên API: ", warehousemanager.value);
                await axios.post("http://127.0.0.1:3000/api/employee2/", formData, {
        ...
        return {handleFileUpload, BASE_URL, back, addWareHouseManager, warehousemanager, selectedFile, isValidEmail, isValidPhone };
    }
}
</script>
